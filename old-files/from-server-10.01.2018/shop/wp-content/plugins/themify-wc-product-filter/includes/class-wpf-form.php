                    ...
                    <?php else: ?>
                        <li>
                                ...
                                <?php else: ?>
                                    <?php if (strpos($type, 'pa_') === 0): ?>
                                        <a class="wpf_pa_link" href="<?php echo get_category_link($cat->term_id) ?>">
                                            <input <?php if($this->selected===$cat->slug):?>readonly <?php endif;?> <?php if (in_array($cat->slug, $value)): ?>checked="checked"<?php endif; ?> type="radio" value="<?php echo $cat->slug ?>" name="<?php echo $name ?>" />
                            ...
                            <?php else: ?>
                                ...
                                ?>
                                    <input <?php if($this->selected===$cat->slug):?>readonly <?php endif;?> <?php if (in_array($cat->slug, $value)): ?>checked="checked"<?php endif; ?> id="wpf_<?php echo $this->themplate_id ?>_<?php echo $cat->term_id ?>" type="<?php echo $args['show_as'] ?>" name="<?php echo $name; ?>[]" value="<?php echo $cat->slug ?>" />
