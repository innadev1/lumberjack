		...
		if ( is_null( $this->fields ) ) {
			$this->fields = array(
				...
				'order'    => array(
					'order_comments' => array(
						...
						'placeholder' => esc_attr__( 'Заметки о заказе, специальные заметки для доставки.', 'woocommerce' ),
					),
				),
			);
			if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) {
				$this->fields['account']['account_username'] = array(
					'type'         => 'text',
					'label'        => __( 'Имя пользователя', 'woocommerce' ),
					'required'     => true,
					'placeholder'  => esc_attr__( 'Имя пользователя', 'woocommerce' ),
				);
			}
			...
			if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) {
				$this->fields['account']['account_password'] = array(
					'type'         => 'password',
					'label'        => __( 'Пароль', 'woocommerce' ),
					'required'     => true,
					'placeholder'  => esc_attr__( 'Пароль', 'woocommerce' ),
				);
			}
