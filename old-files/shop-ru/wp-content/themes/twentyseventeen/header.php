...
<?php
	...
	$language['lv']['franchise_'] = 'http://lumberjackbarbershop.com/downloads/lumberjack_barbershop_franchise_en.pdf';
	$language['en']['franchise_'] = 'http://lumberjackbarbershop.com/downloads/lumberjack_barbershop_franchise_en.pdf';
	$language['ru']['franchise_'] = 'http://lumberjackbarbershop.com/downloads/lumberjack_barbershop_franchise_ru.pdf';
...
<div id="information">
	<div class="information">
		<ul>
			...
			<li class="border"></li>
			<li><a href="http://lumberjackbarbershop.com/contacts.php"><img src="<?php echo home_url(); ?>/img/call.png" width="1%"></a></li>
			<li class="border"></li>
			<li><a href="http://lumberjackbarbershop.com/shop-ru/lv/cart/"><img src="<?php echo home_url(); ?>/img/bag.png" width="0.8%"></a></li>
			<li class="border"></li>
...
<div id="logo">
	<a href="http://lumberjackbarbershop.com/index.php"><img src="<?php echo home_url(); ?>/img/logo.png"></a>
</div>
...
<div id="box" style="display: none;">
    ...
    <div>
        <ul class="box_li">
			<li><a href="http://lumberjackbarbershop.com/index.php">HOME</a></li>
			<li><a href="http://lumberjackbarbershop.com/our_story.php"><?php echo $language[$lang]['our_story'] ?></a></li>
			<li><a href="http://lumberjackbarbershop.com/shop-ru/shop"><?php echo $language[$lang]['online_store'] ?></a></li>
			<li><a href="http://lumberjackbarbershop.com/barbershop.php"><?php echo $language[$lang]['our_barber'] ?></a></li>
			<li><a href="http://lumberjackbarbershop.com/haircuts.php"><?php echo $language[$lang]['haircuts'] ?></a></li>
			<!--<li><a href="http://lumberjackbarbershop.com/lumberjack/lifestyle.php"><?php echo $language[$lang]['lfs'] ?></a></li>-->
			<li><a href="http://lumberjackbarbershop.com/wall_of_fame.php"><?php echo $language[$lang]['wof'] ?></a></li>
			<li><a href="http://lumberjackbarbershop.com/price_list.php"><?php echo $language[$lang]['price_list'] ?></a></li>
			<li><a href="http://lumberjackbarbershop.com/contacts.php"><?php echo $language[$lang]['contact_us'] ?></a></li>
			<li><a href="http://lumberjackbarbershop.com/partners.php"><?php echo $language[$lang]['partners'] ?></a></li>
        </ul>
    </div>
	<div class="information">
...
<div id="navigation">
	<div class="navigation">
			<ul>
				...
				<li class="link"><a href="http://lumberjackbarbershop.com/our_story.php"><?php echo $language[$lang]['our_story'] ?></a></li>

				<li><a><img src="<?php echo home_url(); ?>/img/vector.png"></a></li>
				<li class="link"><a href="http://lumberjackbarbershop.com/barbershop.php"><?php echo $language[$lang]['our_barber'] ?></a></li>

				<li><a><img src="<?php echo home_url(); ?>/img/vector.png"></a></li>
				<li class="link"><a href="http://lumberjackbarbershop.com/shop-ru/shop"><?php echo $language[$lang]['online_store'] ?></a></li>

				<li><a><img src="<?php echo home_url(); ?>/img/vector.png"></a></li>
				<li class="link"><a href="http://lumberjackbarbershop.com/haircuts.php"><?php echo $language[$lang]['haircuts'] ?></a></li>

				<!--<li><a><img src="<?php echo home_url(); ?>/img/vector.png"></a></li>
				<li class="link"><a href="http://lumberjackbarbershop.com/lifestyle.php"><?php echo $language[$lang]['lfs'] ?></a></li>-->
				
				<li><a><img src="<?php echo home_url(); ?>/img/vector.png"></a></li>
				<li class="link"><a href="http://lumberjackbarbershop.com/wall_of_fame.php"><?php echo $language[$lang]['wof'] ?></a></li>
								
				<li><a><img src="<?php echo home_url(); ?>/img/vector.png"></a></li>
				<li class="link"><a href="http://lumberjackbarbershop.com/price_list.php"><?php echo $language[$lang]['price_list'] ?></a></li>

				<li><a><img src="<?php echo home_url(); ?>/img/vector.png"></a></li>
				<li class="link"><a href="http://lumberjackbarbershop.com/contacts.php"><?php echo $language[$lang]['contact_us'] ?></a></li>
			
				<li><a><img src="<?php echo home_url(); ?>/img/vector.png"></a></li>
				<li class="link"><a href="http://lumberjackbarbershop.com/partners.php"><?php echo $language[$lang]['partners'] ?></a></li>

                <!-- <button type="button" class="proBott" href="http://lumberjackbarbershop.com/shop/en_US/cart/" >Click Me!</button>
...
<div class="cartStuff">
    <nav>
        <?php 
            $navArt = array('theme_location' => 'cartmenu');
            wp_nav_menu($navArt);
        ?>
    </nav>
</div>