...
if ( ! function_exists( 'woocommerce_catalog_ordering' ) ) {
	...
	function woocommerce_catalog_ordering() {
		...
		$catalog_orderby_options = apply_filters( 'woocommerce_catalog_orderby', array(
			'menu_order' => __( 'Сортировка по умолчанию', 'woocommerce' ),
			'popularity' => __( 'Сортировать по популярности', 'woocommerce' ),
			'rating'     => __( 'Сортировать по среднему рейтингу', 'woocommerce' ),
			'date'       => __( 'Сначала новые', 'woocommerce' ),
			'price'      => __( 'Цена: от дешевого к дорогому', 'woocommerce' ),
			'price-desc' => __( 'Цена: от дорогого к дешевому', 'woocommerce' ),
		) );
...
function wc_empty_cart_message() {
	echo '<p class="cart-empty">' . apply_filters( 'wc_empty_cart_message', __( 'Корзина пуста.', 'woocommerce' ) ) . '</p>';
}
