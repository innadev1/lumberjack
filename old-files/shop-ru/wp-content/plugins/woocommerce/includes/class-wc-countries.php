...
class WC_Countries {
	...
	public function get_default_address_fields() {
		$fields = array(
			...
			'company' => array(
				'label'        => __( 'Название компании', 'woocommerce' ),
			...
			'address_1' => array(
				...
				'placeholder'  => esc_attr__( 'Номер дома и название улицы', 'woocommerce' ),
				'required'     => true,
			...
			'address_2' => array(
				'placeholder'  => esc_attr__( 'Номер квартиры', 'woocommerce' ),
				'class'        => array( 'form-row-wide', 'address-field' ),
				'required'     => false,
			...
			'postcode' => array(
				'label'        => __( 'Почтовый код', 'woocommerce' ),
				'required'     => true,
				'class'        => array( 'form-row-wide', 'address-field' ),
	...
	public function get_address_fields( $country = '', $type = 'billing_' ) {
		...
		if ( 'billing_' === $type ) {
			...
			$address_fields['billing_email'] = array(
				'label'        => __( 'Адрес электронной почты', 'woocommerce' ),
				'required'     => true,
				'type'         => 'email',
				'class'        => array( 'form-row-last' ),
